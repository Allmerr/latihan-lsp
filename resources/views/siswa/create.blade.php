    ...
    <div class="form-siswa rounded">
        ...
        <form action="{{ route('siswa.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nis" class="form-control @error('nis') error @enderror" value="{{ old('nis') }}" required>
            </div>
            <div class="mb-3">
                <label for="nama_siswa" class="text-left">Nama Siswa</label>
                <input type="text" name="nama_siswa" class="form-control @error('nama_siswa') error @enderror" value="{{ old('nama_siswa') }}" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="alamat" id="alamat" cols="30" rows="3" class="form-control @error('alamat') error @enderror" required>{{ old('alamat') }}</textarea>
            </div>
            <div class="mb-3">
